...
class CPPE {
 public:
  ...
  // initialize_gen1int(int natoms, int nshells, const double *coords,
  //                         const double *charges);
  // void gen1int_add_shell(int spher_gto, int idx_center,
  //                        const double *coord_center, int ang_num, int
  //                        num_prim, const double *exponents, int num_contr,
