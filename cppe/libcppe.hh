...
public:
  ...
  // void call_full_fock(const double* densmat, double* fockmat, double*
  // energy); bool gen1int_initialized() { return m_gen1int_initialized; } void
  // initialize_gen1int(int natoms, int nshells, const double* coords, const
  // double *charges); void gen1int_add_shell(int spher_gto, int idx_center,
