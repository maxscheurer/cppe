...
// }
//
// void CPPE::gen1int_add_shell(int spher_gto, int idx_center, const double*
// coord_center,
//   int ang_num, int num_prim, const double* exponents, int num_contr, const
//   double* contr_coef) { gen1int_api_add_shell(spher_gto, idx_center,
//   coord_center, ang_num, num_prim, exponents, num_contr, contr_coef);
// }
//
// void CPPE::gen1int_print_shells() {
//   if (!m_gen1int_initialized) {
//     throw std::runtime_error("Gen1int needs to be initialized before calling
//     print_shells");
//   }
//   print_shells();
// }
//
// void CPPE::initialize_pelib(PeOptions& options, int natoms, int nbas, const
// double* coords, const double* charges) {
//   if (!m_gen1int_initialized) {
//     throw std::runtime_error("Gen1int needs to be initialized before calling
//     PElib");
//   }
...
//   if (!m_gen1int_initialized || !m_pe_initialized) {
//     throw std::runtime_error("Gen1int and PElib need to be initialized before
//     calling PElib");
//   }
...
// }
//
// void CPPE::call_full_fock(const double* densmat, double* fockmat, double*
// energy) {
//   if (!m_gen1int_initialized || !m_pe_initialized) {
//     throw std::runtime_error("Gen1int and PElib need to be initialized before
//     calling PElib");
