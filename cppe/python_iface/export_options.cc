...
void export_options(py::module& m) {
  ...
  py::class_<libcppe::BorderOptions> pe_border_options(m, "PeBorderOptions",
                                                       "Border Options for CPPE library");
  ...
  // libcppe::PeOptions
  py::class_<libcppe::PeOptions> pe_options(m, "PeOptions", "Options for CPPE library");
