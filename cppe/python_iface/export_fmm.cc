...
static std::shared_ptr<Tree<1, 3>> __build_tree(py::array_t<double, py::array::c_style> positions,
...
static void __set_sources(const std::shared_ptr<Tree<1, 3>>& self, py::array_t<double, py::array::c_style> sources) {
...
void export_fmm(py::module& m) {
  ...
  py::class_<Tree<1, 3>, std::shared_ptr<Tree<1, 3>>> tree(fmm, "Tree", "Tree class for FMM/BH.");
