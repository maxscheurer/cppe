...
Eigen::VectorXd T5(const Eigen::Vector3d& rij)
{
    ...
    result[12] = -x10*(2.0*x33*(4.0*x39 - 1.0) + 20.0*x38*x6 + (x30 - 1.0)*(5.0*x33 - 1.0)); // xyyzz
...
Eigen::VectorXd T6(const Eigen::Vector3d& rij)
{
    ...
    result[12] = 15.0*x11*(693.0*x2*x23*x9 + x20 - x23*x54 - x28*x54 + x30 + x46 - x54*x55); // xxyyzz
    ...
    result[17] = 105.0*x16*y*(28.0*x55*x7 + 2.0*x59 + (x20 - 3.0)*(x41 - 1.0)); // xyyyzz
    result[18] = 45.0*x16*z*(10.0*x30*x31 + 8.0*x31*(2.0*x40 - 1.0) + 10.0*x59 + 7.0*(5.0*x31 - 1.0)*(x44 - 1.0)); // xyyzzz
...
Eigen::VectorXd T1_damp_thole(const Eigen::Vector3d& rij, double a)
{
    ...
    double x2 = -x1;
    double x3 = exp(x2);
    double x4 = -0.5*a*x3*(x2 - 1.0)*1.0/x0 + 0.5*pow(x0, -1.5)*(x3*(x1 + 2.0) - 2.0);
    result[0] = x*x4; // x
    result[1] = x4*y; // y
    result[2] = x4*z; // z
    return result;
...
Eigen::VectorXd T2_damp_thole(const Eigen::Vector3d& rij, double a)
{
    ...
    double x24 = x*x23;
    result[0] = -x0*x8 - x14*(x0*x10 - 1.0) - x21*(-x0*x17 + x0*x18 + x12*x15 - x15 + x20); // xx
    result[1] = -x24*y; // xy
    result[2] = -x24*z; // xz
    result[3] = -x1*x8 - x14*(x1*x10 - 1.0) - x21*(-x1*x11 - x1*x17 + x1*x18 + x1*x22 + x20); // yy
    result[4] = -x23*y*z; // yz
...
Eigen::VectorXd T3_damp_thole(const Eigen::Vector3d& rij, double a)
{
    ...
    double x55 = -x23 + x49;
    double x56 = 0.5*x39;
    double x57 = x0*x42 + x0*x44 + x21*x50 + x28*x52 + x30*x51 + x46*x6 + x47*x6 - x56*(x0*x53 - x0*x54 + x21*x33 + x31 - x35 + x55);
    double x58 = 7.5*x43;
    ...
    double x78 = x20*x29;
    double x79 = x2*x4;
    result[0] = x40*(x13*x6 + x18*(5.0*x5 - 3.0) + x20*x30 + x39*(-x0*x32 - x0*x34 + x0*x37 + x22*x33 - x31 + x35 + x38)); // xxx
    result[1] = x57*y; // xxy
    result[2] = x57*z; // xxz
    result[3] = x*(x1*x58 + x1*x64 + x56*(x59 + x63) + x65 + x69); // xyy
    result[4] = x40*y*z*(x20*x50 + x39*(-x17 - x32 - x34 + x37 + x70 + x71) + 9.0*x41 + 15.0*x43); // xyz
    result[5] = x*x75; // xzz
    result[6] = 0.5*y*(x13*x77 + x18*(5.0*x76 - 3.0) + x39*(x38 + x63) + x67*x78); // yyy
    result[7] = z*(x1*x42 + x1*x44 + x46*x77 + x47*x77 + x52*x67 - x56*(x1*x53 - x1*x54 + x33*x66 + x55 + x60 - x61) + x69); // yyz
    result[8] = x75*y; // yzz
...
Eigen::VectorXd T4_damp_thole(const Eigen::Vector3d& rij, double a)
{
    ...
    double x114 = x*(-1.5*x101 + x102*x51 + x104*x51 + x23*x83 + x23*x93 + x35*x94 + x6*x84 + x6*x86 - x74*(x0*x62 - x105*x106 + x105*x69 + x109 + x113 - x38*x45 + 27.0*x8) + x75*x78 + 15.0*x80 + x96);
    double x115 = x1*x41;
    double x116 = 5.0*x69;
    double x117 = x0*x116;
    double x118 = 23.0*x8;
    ...
    double x176 = x1*x69;
    double x177 = 15.0*x1;
    double x178 = -x1*x59 + x106*x177 - x172 - x173*x38 + x174*x18 - 4.0*x174 + x175 + 6.0*x176*x18;
    ...
    double x200 = x2*x62;
    double x201 = x18*x2;
    double x202 = x18*x198 + x18*x200 - x198 - x199*x38 - x2*x59 - 4.0*x200 + x201*x70 + x201*x71;
    double x203 = x168*x52;
    double x204 = x2*x52;
    double x205 = x182*x2 + x184*x204*x76;
    double x206 = x166 + x50;
    double x207 = x102*x206 + x181*x204 + x189 + 1.5*x197 + x203*x94 + x205 + x74*(x171 + x202);
    ...
    result[0] = -x14*x6*x8 - x22*(x15*x17 - 30.0*x5 + 3.0) - x23*x25*x35 - 2.0*x51*x53 - x74*(-x0*x67 - x15*x59 - x15*x60 + x18*x56 - x18*x58 + x18*x63 - 6.0*x40 - x56 + x58 - 4.0*x63 + 18.0*x64 + 36.0*x65 + x68*x70 + x68*x71 + x72); // xxxx
    result[1] = -x114*y; // xxxy
    result[2] = -x114*z; // xxxz
    result[3] = -x1*x127 - x1*x128 - x1*x138 - x1*x144 - x1*x147 - x1*x96 + x129*x130 - x129*x142 + x131*x132 - x137*x53 - x140*x23 - x150*x23 + x152 + x74*(x1*x107 - x1*x108 + x1*x117 + x1*x118 - x1*x120 - x115 + x125 + x126); // xxyy
    result[4] = -x160*(-x100*x103 - x101 + x127 + x128 + x138 + x142*x24 + x144 + x147 + x154 + x155*x23 + x159*x53 - x74*(x109 + x117 + x118 - x120 + x158 - x41) + x96); // xxyz
    result[5] = -x127*x2 - x128*x2 + x130*x163 + x132*x164 - x138*x2 - x142*x163 - x144*x2 - x147*x2 + x152 - x154*x2 - x167*x53 - x169*x23 - x2*x96 + x74*(x107*x2 - x108*x2 + x117*x2 + x118*x2 - x120*x2 + x121 + x126 + x162 + x28); // xxzz
    result[6] = -x190*(1.5*x179 + x180*x181 + x185 + x188 + x189 + x74*(x171 + x178)); // xyyy
    result[7] = -x196*(x129*x193 + x179 + x180*x194 + x185 + x192 + x195 + x74*(x178 + x191)); // xyyz
    result[8] = -x190*(x163*x193 + x194*x204 + x195 + x197 + x203*x21 + x205 + x74*(x191 + x202)); // xyzz
    result[9] = -x196*x207; // xzzz
    result[10] = -x14*x148*x208 - 2.0*x186*x211 - x187*x210*x25 - x22*(-30.0*x131 + x17*x209 + 3.0) - x74*(-x1*x67 - 6.0*x135 - x173*x18 + x173 + x18*x212 + x18*x213 - x209*x59 - x209*x60 - x212 - 4.0*x213 + 18.0*x214 + 36.0*x215 + x216*x70 + x216*x71 + x72); // yyyy
    result[11] = -x160*(x104*x186 + x177*x79 + x183*x75 + x188 + x208*x84 + x208*x86 + x210*x83 + x210*x93 - x219*x92 + x220 - x74*(x113 - x123*x38 - 12.0*x148*x18 + 27.0*x148 + x172 + x174 - x175 + 12.0*x176)); // yyyz
    result[12] = x1*x151 + x104*x139 + x11*x164*x219*x38 - x139*x141*x163 + x140 - x143*x222*x76 - x146*x222 + x150 - x153*x223 - x167*x211 - x169*x210 - x192*x2 - x2*x220 + x210*x22 + x219*x224 - 30.0*x221*x79 - x223*x86 + x74*(x116*x221 - x119*x225 + x125 + x162 + x172*x2 - x175*x2 - x214 - x217 + x218 + 23.0*x225); // yyzz
...
Eigen::VectorXd T5_damp_thole(const Eigen::Vector3d& rij, double a)
{
    ...
    double x78 = -x0*x71 + x20*x60 + x20*x67 - 6.0*x44 - x6*x63 + x6*x74 + x6*x76 - x60 - x61*x64 + x62 - x65 - 4.0*x67 + 18.0*x68 + 36.0*x69 + x77;
    double x79 = x57*x78;
    ...
    double x169 = -a*x141*x38*x42 + x0*x128*x36 - x112*(-90.0*x103 + x163*x20 - x163 - x164*x87 - x165*x89 + x168 + x41*x65 + x82 + 195.0*x86 + 105.0*x87 + 22.0*x89 + x92 - 6.0*x94 - x95 - 72.0*x96 - 162.0*x97 + 72.0*x98) + x116*x6 + 30.0*x118*x36 + x121*(7.0*x5 - 3.0) + x123*x9 + x129*x130 + x132*x133 + x133*x135 + x142*x143 + x142*x145 - 2.0*x160*x25 + x162*x78 + x23*x9 + 0.5*x79;
    ...
    double x288 = x150*x2 - x151*x2 + x2*x244 + x2*x245 - x2*x246 + x206 + x248 + x27 + x287;
    ...
    double x333 = -x0*x230 - 54.0*x118 - 90.0*x120 - x134*x250 + x140*x218 + x161*x332 - x221*x262 - x331*x38;
    ...
    double x344 = x1*x334 + x1*x337 - x134*x340 - x194*x332 + x213*x338 + x225*x341 + x236*x343 + x335*x38 - x340*x35 + x341*x342;
    ...
    double x356 = -18.0*x118 - x121 - x123*x38 + x140*x162 + x140*x254 - x221*x35 - x23*x38 - x234*x48 - x263*x32;
    double x357 = x11*x2;
    double x358 = x180*x2;
    double x359 = x117*x2;
    double x360 = x183*x2;
    ...
    double x381 = x2*x339;
    double x382 = 7.5*x2;
    double x383 = x0*x2*x343 - x134*x381 + x2*x334 + x2*x337 + x225*x382 - x272*x332 + x280*x338 + x342*x382 - x35*x381 + x38*x380;
    double x384 = x2*x293;
    double x385 = x0*x384;
    double x386 = x2*x290;
    ...
    double x415 = x100*x412 + x102*x407 + x20*x410 - x395*x406 - x395*x409 - x405 - x407*x408 - 5.0*x410 + x411 + x413*x414;
    ...
    double x430 = x1*x429 - x1*x71 - x20*x312 + x20*x426 + x20*x427 - 6.0*x210 + x312 - x395*x63 + x395*x74 + x395*x76 - x407*x61 - x426 - 4.0*x427 + 18.0*x428 + x77;
    double x431 = x1*x323;
    ...
    double x448 = x41*x61;
    double x449 = x20*x93;
    double x450 = x101 - x102 - x20*x448 + x401 - 3.0*x449 + 54.0*x72 - 45.0*x75 + 12.0*x93;
    ...
    double x477 = x2*x429 - x2*x71 - x20*x366 + x20*x476 + 18.0*x271*x41 - 6.0*x278 + x366 - x448*x475 + x449*x475 - x475*x63 + x475*x74 + x475*x76 - 4.0*x475*x93 - x476 + x77;
    double x478 = x2*x397;
    double x479 = x475*x81;
    double x480 = x475*x91;
    double x481 = x102*x41*x475 + x20*x479 + x20*x480 - x406*x475 - x409*x475 - x436*x475 + x443*x475 + x474*x475 - x479 - 5.0*x480;
    double x482 = x112*(-x2*x20*x401 + x2*x400 - x20*x478 + 180.0*x357 + 24.0*x368 - 6.0*x370 - x371*x403 + x404 + x478 + x481) + x2*x391 - x2*x394 - x2*x418 - x229*x274 - x234*x366 + x254*x477 + x268*x460 - x284*x417 + x379*x389 + 2.0*x388*x465 + x396*x475 + x422*x475 + x424*x475 + x425;
    double x483 = x395*x7;
    ...
    double x515 = x2*x512 + x2*x513 - x2*x514 + x247 + x287 - x428 + x466 - x467 - x494 + x495;
    double x516 = -x218*x515 - x251*x487 - x329 + x457*x487;
    double x517 = x1*x384;
    double x518 = x475*x7;
    double x519 = x2*x489;
    result[0] = x*(x112*(x100*x89 - x100*x94 + x102*x64 + 105.0*x103 + x109 - x20*x84 + x20*x92 - x82 + x84 - 210.0*x86 - 135.0*x87 - 40.0*x89 - 5.0*x92 + 40.0*x94 + x95 - x96*x99 + 180.0*x96 + 300.0*x97 - 150.0*x98) + x18*x9 + x23*(-70.0*x5 + 63.0*x8 + 15.0) + x33*x35*x37 + x38*x55*x58 + 2.5*x79); // xxxxx
    result[1] = x169*y; // xxxxy
    result[2] = x169*z; // xxxxz
    result[3] = x*(x1*x172 + x1*x192 - x1*x198 - x1*x199 + x1*x201 + x1*x220 + x1*x223 + x1*x226 + x1*x228 + x1*x231 + x1*x233 + x1*x235 - x112*(-x1*x174 - x1*x175 + x1*x178 + x1*x179 + x1*x181 + x1*x182 - x1*x184 - x173 + x176 - x185*x41 + x188 + x190) - x160*x193 + x194*x195 - x196*x197 + x205*x36 + x217*x219 + x236*x238 + x243 + x253 + x255); // xxxyy
    result[4] = x266*(-x112*(-x101 + x102 - x174 - x175 + x178 + x179 + x181 + x182 - x184 + x186 - x264 - x265) + x125*x204*x36 - x159*x161 - x159*x56 + x172 + x192 - x198 - x199 + x201 - x218*x261 + x220 + x223 + x226 + x228 + x231 + x233 + x235 + x241 + x256 + x260*x38 + x263*x55); // xxxyz
    result[5] = x*(-x112*(x178*x2 + x181*x2 + x182*x2 - x184*x2 + x190 - x2*x265 + x267 + x270) - x160*x271 + x172*x2 + x192*x2 + x195*x272 - x197*x273 - x198*x2 - x199*x2 + x2*x201 + x2*x220 + x2*x223 + x2*x226 + x2*x228 + x2*x231 + x2*x233 + x2*x235 + x2*x256 + x219*x284 + x255 + x275*x36 + x286 + x289); // xxxzz
    result[6] = y*(x0*x327 + x173*x330 + x242 - x249*x302 + x253 - x301*(x20*x291 - x20*x294 - x291 - 5.0*x292 + x294 + 11.0*x295 + 51.0*x296 - 16.0*x297 + x300) + x321*x322 + x324*x38 + 9.0*x326 + x329*x38 + x333 + x344); // xxyyy
    result[7] = z*(x1*x355 - x112*(x188 - 15.0*x292 + 33.0*x295 + 153.0*x296 - 48.0*x297 + x299 + x345) - x162*x249 - x193*x349 - x196*x351 + x205*x38 + x217*x352 + x236*x354 + x243 - x249*x254 + x322*x347 + 3.0*x326 + x344 + x348*x38 + x353*x38 + x356); // xxyyz
    result[8] = y*(x0*x259*x379 - x112*(x267 + x299 - 15.0*x357 + 33.0*x358 + 153.0*x359 - 48.0*x360 + x364) - x162*x288 + x2*x355 - x254*x288 - x271*x349 - x273*x351 + x275*x38 + x284*x352 + x286 + x322*x375 + x356 + x376*x38 + 3.0*x377 + x378*x38 + x383); // xxyzz
    result[9] = z*(x0*x391 + x268*x330 + x285 - x288*x302 + x289 - x301*(-x20*x385 + x300 + 11.0*x358 + 51.0*x359 - 16.0*x360 + x385 + x387) + x322*x388 + x333 + 9.0*x377 + x38*x390 + x38*x393 + x383); // xxzzz
    result[10] = x*(x1*x327 - x1*x394 - x1*x418 + x112*(x1*x400 + 180.0*x292 + 24.0*x314 - 6.0*x316 - x317*x403 + x398 - x399 - x401*x402 + x404 + x415) + x173*x423 - x217*x417 - x234*x312 + x321*x420 + x395*x396 + x395*x422 + x395*x424 - x416 + x425 + x432); // xyyyy
    result[11] = x266*(x1*x424 + x1*x455 + x112*(-x434 - x435 - x437 - x438 - x440 + x441 + x442 + x444 + x445 + x447 + x450) + x218*x347 + x259*x454 + x321*x57 + x327 + x433 + x451 + x453 + x456); // xyyyz
    result[12] = x*(-x1*x240 + x112*(-x2*x435 - x2*x437 - x2*x438 - x2*x440 + x2*x442 + x2*x444 + x2*x445 + x2*x447 + x259 + x311 + x313 + x315 - x316 - x318 - x319 + x361 - x363 + x365 + x367 + x369 - x370 - x372 - x373 - x469 + x470 + x471) + x114*x125*x459 + x123 + x2*x433 - x205 + x217*x464 + x23 + x254*(x125 - x2*x311 - x2*x313 - x2*x315 + x2*x316 + x2*x318 + x2*x319 + x208 + x209 - x210 - x212 + x276 + x277 - x278 - x279 + x280 - x281 - x466 + x467 + x468) - x275 + x284*x454 - x335 + x341*x461 + x347*x465 - x348 - x353 + x354*x458 + x375*x419 - x376 - x378 - x380 + x424*x458 - x457 + x463); // xyyzz
    result[13] = x266*(x112*(-x2*x406 - x2*x409 - x2*x436 + x2*x443 + x2*x474 + x20*x472 + x20*x473 + x269*x41 + x450 - x472 - 5.0*x473) + x2*x396 + x2*x424 + x2*x455 + x204*x389 + x218*x375 + x259*x464 + x274*x452 + x388*x57 + x391 + x456); // xyzzz
    result[14] = x*x482; // xzzzz
    result[15] = y*(x112*(x109 - x20*x490 + 300.0*x292 + 40.0*x314 - 10.0*x316 - x317*x99 + 180.0*x317 + x415 + x490 - 150.0*x491) + x18*x484 + x203*x485*x486 + x23*(-70.0*x196 + 63.0*x483 + 15.0) + x323*x487*x58 + x430*x488); // yyyyy
    result[16] = z*(x1*x128*x485 + 18.0*x1*x462 - x112*(-x164*x493 - x165*x412 + x168 + x20*x313 - 90.0*x20*x413 - 162.0*x292 - 6.0*x314 - 72.0*x317 - x398 + x399 + x405 + x410 - x411 + 22.0*x412 + 195.0*x413 + 72.0*x491 + 105.0*x493) + x116*x395 + x123*x484 + x145*x431 + x162*x430 + x203*x487*x502 + x23*x484 + x416*x487 - x417*x487*x496 - x420*x501 + x432 + 30.0*x485*x503 + 30.0*x492*(7.0*x196 - 3.0)); // yyyyz
    result[17] = y*(x110*x272*x323 - x112*(x167 + x177*x458 + x270 + x306 - x314 - x41*x467 + x469 - x470 - x497 - x498 + x499 + x500 + 72.0*x506 + 177.0*x507 - 72.0*x508) + x122*x134*x2*x323 - x134*x505 - x162*x323 + x2*x222*x505 + x2*x230*x487 + 15.0*x2*x232*x485 + x2*x451 + x2*x453 + x218*x284*x487 - x229*x509 - x23*x485 + 18.0*x234*x459 + x238*x458 - x273*x350*x501 + x275*x485 - x324 + x380*x485 - x465*x501 - 15.0*x492 - x502*x509 - 9.0*x503 + 210.0*x504 + 10.5*x510*x511 + x516); // yyyzz
    result[18] = z*(-x1*x230 + x1*x391 + 9.0*x1*x461 - x122*x272*x496 + x14*x203*x280*x66 - x144*x328 - 4.5*x144*x509 + x173*x2*x234 + x203*x382*x511 + x218*x496 - x262*x505 - x301*(-x20*x517 + x345 + x387 + x45 + 11.0*x506 + 51.0*x507 - 16.0*x508 - x512 - x513 + x514 + x517) + x302*x496 - x302*x515 - x331*x487 + x336*x510 + x343*x458 + x380*x487 + x388*x419 + x390*x487 + x393*x487 + x463 - x464*x496 - 90.0*x492 - 54.0*x503 + 315.0*x504 + x516); // yyzzz
...
Eigen::VectorXd T6_damp_thole(const Eigen::Vector3d& rij, double a)
{
    ...
    double x84 = x24*x65 + x24*x73 - 6.0*x48 - x6*x69 + x6*x80 - x65 - x66*x70 + x67 - x71 - 4.0*x73 + 18.0*x74 + 36.0*x75 - x76*x77 + x81*x82 + x83;
    double x85 = a*x31;
    double x86 = x15*x85;
    double x87 = 7.5*x86;
    double x88 = x0*x23;
    ...
    double x126 = x0*x99 - x100*x102 + 300.0*x100 + x101 - x103*x104 - 10.0*x105 + 10.0*x106 + x108*x70 + 105.0*x109 + x114 + x125 - x24*x89 + x89 - 210.0*x90 - 135.0*x91 - 40.0*x93 - 5.0*x96 + 40.0*x98;
    double x127 = a*x46;
    ...
    double x231 = x15*(x112 - x113 - x214 - x215 - x216 - x217 + x218 + x219 + x220 + x221 - x222 - x224 - x225 + x226 + x227 + x230 + x96);
    ...
    double x258 = x*(x126*x233 + x126*x235 - x157*(-x0*x241 - x104*x243 + x111*x238 - 1950.0*x12 + x143*x6 + x236*x24 - x236 + x237 - x238*x88 - x239 + 40.0*x24*x240 - 220.0*x240 + 35.0*x242 + 285.0*x243 + 1785.0*x244 - 840.0*x245 - 315.0*x247 - x249*x82 + x250*x251 + 900.0*x252 + x257) + 150.0*x159*x161 + x164*(9.0*x5 - 5.0) + 37.5*x166 + x167*x9 + x169*x9 + x170*x173 + 150.0*x176 + 75.0*x178*x61 + 15.0*x180*x61 - x185*x186*x61 + x186*x190 + x189 + x190*x193 - x209*x210*x63 + 7.5*x212 + 2.5*x213 - 2.5*x232);
    ...
    double x285 = x114 + x208 + x214 + x215 + x216 + x217 - x218 - x219 - x220 - x221 + x222 + x224 + x225 - x226 - x227 - x96;
    double x286 = 12.0*x4;
    double x287 = x0*x1;
    double x288 = 42.0*x7;
    ...
    double x313 = x1*x302 + x1*x303 + x1*x304 - x1*x305 - x262 - x264 + x269 - x282 + x283 - x306*x45 + x310 + x312;
    ...
    double x326 = x1*x199 - x1*x319 + x287*x317 + x287*x318 - x306 - x316 + x324 + x325;
    ...
    double x390 = a*x388*x63 + x175*x389 + 30.0*x18*x61 + 3.0*x191*x365 + x233*x84 + x235*x84 + x244*x381 + x28*x385 + x363*x386 + x386*x387;
    double x391 = x24*x51;
    ...
    double x403 = x15*(-x261 - x263 + x268 + x302 + x303 + x304 - x305 + x307 - x400 - x401 + x402);
    double x404 = a*x403;
    double x405 = x31*x72;
    ...
    double x435 = x2*x302 + x2*x303 + x2*x304 - x2*x305 - x2*x401 + x312 + x433 + x434;
    double x436 = x2*x51;
    double x437 = x2*x391;
    double x438 = -x436 + x437;
    double x439 = -x2*x49 + x438;
    double x440 = x199*x2 - x2*x200 - x2*x319 + x2*x394 + x2*x395 + x320 + x325 + x34 + x439;
    ...
    double x473 = -x1*x464 + x1*x467 + x1*x468 - x1*x469 + x24*x463 - x24*x466 - x463 + x466 + x472;
    double x474 = 4.5*x86;
    ...
    double x581 = -315.0*x161 - 630.0*x163 - x172*x557 - 67.5*x178 - 31.5*x180 + x185*x462 + x185*x475 - x192*x576 + x209*x477 + x209*x494 - x367*x577 - 27.0*x383 - x405*x578 - x42*x576 - x575*x61 - 67.5*x579 - x580*x61;
    double x582 = x*y;
    ...
    double x621 = 105.0*x161 + x164 + x167*x61 + x169*x61 + 10.5*x180 - x185*x518 - x185*x598 + x191*x578 - x209*x233 - x209*x235 + x30*x578 + x367*x547 + 9.0*x383 + x406*x59 + 22.5*x579 + x618 + x620;
    double x622 = x*z;
    ...
    double x750 = x108*x725 - x710*x744 + x720*x749 - 210.0*x720 - x725*x743 - 5.0*x745 + x746 + x747*x748;
    double x751 = x1*x731 + x1*x732 - x1*x735 - x24*x734 + 24.0*x538 - 6.0*x540 + x741 + x742 + x750;
    ...
    double x784 = x24*x76;
    double x785 = x24*x81;
    double x786 = x1*x783 - x1*x784 - x24*x374 + x24*x780 - 6.0*x359 + x374 - x64*x710 - x66*x725 - x69*x710 + x710*x785 + x710*x80 - 4.0*x780 + x781 + 18.0*x782 + x83;
    ...
    double x846 = -x130*x162 - 495.0*x161 - 22.5*x180 + x185*x604 + 9.0*x371 - 99.0*x383 - x388*x72 - x393*x835 + x397*x477 + x397*x494 + x46*x754 - x499*x547 - x575*x63 - x618 - x620 - x63*x845;
    ...
    double x869 = x172 - x2*x536 - x2*x537 - x2*x539 + x2*x540 + x2*x543 + x357 + x358 - x359 - x360 + x436 - x437 + x448 + x449 - x450 - x451 + x80*x849 - x866 + x867 + x868;
    ...
    double x886 = x2*x817;
    double x887 = x2*x818;
    double x888 = x536 + x537 + x539 - x540 - x541 - x543 + x880 + x881 + x882 + x883 + x884 + x885 + x886 + x887;
    ...
    double x921 = x108*x909 + x24*x917 - x743*x909 - x744*x907 + x748*x920 + x749*x913 - 210.0*x913 - x917 - 5.0*x918 + x919;
    double x922 = x2*x731 + x2*x732 - x2*x735 - x24*x915 - x24*x916 + 24.0*x665 - 6.0*x667 + x742 + x915 + x921;
    double x923 = x7*x907;
    double x924 = x2*x440;
    ...
    double x929 = x2*x783 - x2*x784 - x24*x455 + x429*x752 - 6.0*x450 + x455 - x64*x907 - x69*x907 + x785*x907 + x80*x907 - x822*x907 + x824*x907 + x83 - 4.0*x907*x97 + x928;
    ...
    double x939 = x1*x241;
    double x940 = -x150 + x24*x255 - x253 + x254 + 225.0*x256 - 450.0*x68 + 90.0*x79 - 60.0*x97;
    ...
    double x948 = -x135*x710 - x136*x717 - x141*x710 + x24*x943 - x710*x942 + x717*x946 + x749*x945 + x781*x94 - x941 - 6.0*x943 + x944 + 945.0*x947;
    ...
    double x958 = x1*x955 - x1*x956 - x1*x957 + x1*x99 + x125 - x24*x954 + 40.0*x538 - 10.0*x540 + x737 + x740 + x750 + x954;
    ...
    double x980 = -x135*x849 - x136*x856 + x149*x979 + x153*x979 - 75.0*x2*x271 + x24*x977 + x24*x978 - x849*x942 + x856*x946 + x867*x94 + x969 - x977 - 6.0*x978;
    ...
    double x988 = x2*x282*x839 + x477*x890 + x518*x869 - x560 - x709 + x849*x961 + x849*x963 + x975 + 577.5*x987;
    ...
    double x999 = -x135*x907 - x136*x911 - x141*x907 + x149*x998 + x153*x998 + x24*x996 + x24*x997 - x907*x942 + x911*x946 + x928*x94 - x996 - 6.0*x997;
    ...
    double x1005 = -x1004*x24 + x1004 + x125 + x2*x955 - x2*x956 - x2*x957 + x2*x99 + 40.0*x665 - 10.0*x667 + x921;
    double x1006 = 1050.0*x427;
    double x1007 = x1001*x186 + 262.5*x1002 + x1003 + x1005*x233 - x115*x651 + x157*(-x1006*x24 + x1006 - x241*x872 + 2100.0*x445 + 1350.0*x624 - 1050.0*x628 + 50.0*x895 - x898*x938 + 400.0*x898 + x940 - 450.0*x995 + x999) + x170*x929 - x186*x706 - x210*x708 - x253*x649 + 75.0*x416*x651 + 525.0*x427*x649 - 4725.0*x632 + 75.0*x657*x706 - 2100.0*x687 + x960 + 2.5*x993;
    ...
    double x1037 = -x1027 - x1028 - x1029 + x1030 + x1031 + x1032 - x1033 - x1034 - x1035 + x1036 + x230 + x736 - x738 + x739 - x740 + x745 + x989;
    ...
    double x1060 = -x1038 + x1039 + x317*x849 + x318*x849 + x324 - x410*x849 + x439 - x782 + x866 - x867;
    double x1061 = x1060*x128;
    double x1062 = 7.0*x815;
    double x1063 = 72.0*x478;
    double x1064 = 177.0*x350;
    double x1065 = 72.0*x480;
    double x1066 = -x1041 - x1042 + x1043 + x1044 + x1062*x2 + x1063*x2 + x1064*x2 - x1065*x2 + x229 + x434 - x45*x867 + x531 - x538 + x873 - x875;
    ...
    double x1074 = 11.0*x1067 - 16.0*x1069 - x1070 - x1071 - x1072 + x1073 + x2*x804 + x49 + x595 + x696 + 51.0*x871;
    ...
    result[0] = -x0*x126*x128 - x157*(x100*x145 - 1350.0*x100 - 15.0*x101 - x102*x93 - 810.0*x103 + 45.0*x105 - 1575.0*x109 + x131*x24 - x131 + x132*x24 - x132 - x133*x24 + x133 - x135*x20 - x137*x20 - x138*x139 + x139*x152 - x141*x20 + x144*x24 - 6.0*x144 - x145*x91 + x147*x20 + x148*x149 + x148*x153 + x150*x77 + x154 + 3150.0*x90 + 2025.0*x91 + 600.0*x93 + 75.0*x96 - 180.0*x98) - x19*x9 - x27*(x20*x22 + 105.0*x5 - 315.0*x8 - 5.0) - x28*x30*x41 - x42*x60*x62 - x63*x84*x87; // xxxxxx
    result[1] = -x258*y; // xxxxxy
    result[2] = -x258*z; // xxxxxz
    result[3] = -x1*x189 - x1*x329 - x1*x335 - x1*x340 - x1*x341 - x1*x344 - x1*x349 + x1*x372 + x1*x377 - x1*x384 + x157*(x1*x237 - x1*x239 - x1*x265 - x1*x266 - x1*x267 + x1*x273 + x1*x274 + x1*x275 - x1*x276 - x1*x277 - x1*x279 + x1*x280 + x1*x281 + x24*x260 - x260 + x262 + x264 - x269 + x271*x272 + x284 + x285) - x282*x345 - x287*x301 - x287*x348 - x291*(-x1*x286 + x287*x288 + x289) - x293*x294 + x295*x296 + x297*x298 + x313*x315 - x321*x366 + x328*x63 - x331*x334 - x336*x337 - x351*x352 - x353*x355 - x355*x368 - x362*x364 + x369*x370 + x370*x373 + x374*x376 - x378*x380 - x379*x382 + x390; // xxxxyy
    result[4] = -x414*(x0*x134*x382 + x0*x348 + x107*x345 - x128*x397*x63 + x161*x378 + x163*x300 + 180.0*x163*(x158 - 2.0) + 15.0*x166 + x169*x28 + x173*x333 + x189 - x231*x234 - x232 - 2.0*x32*x404 + x329 + x335 + x340 + x341 + x344 + x349 + x353*x398 + x364*x393 + x366*x51 + x368*x398 - x369*x399 - x372 - x373*x399 - x376*x66 - x377 + x384 + x406*x84 - x413*(-354.0*x12 + x223*x250 - x24*x409 - 14.0*x240 + 3.0*x242 + 54.0*x243 + 555.0*x244 - 240.0*x245 + 275.0*x246 - 70.0*x247 - 144.0*x250 + 144.0*x252 - 8.0*x278 + x317 + x318 - x407 + x409 - x410 + x411 + x412)); // xxxxyz
    result[5] = x157*(x2*x237 - x2*x239 - x2*x265 - x2*x266 - x2*x267 + x2*x273 + x2*x274 + x2*x275 - x2*x276 - x2*x277 - x2*x279 + x2*x280 + x2*x281 + x24*x415 + x272*x417 + x285 - x415 + x424) - x189*x2 - x2*x329 - x2*x335 - x2*x340 - x2*x341 - x2*x344 - x2*x349 + x2*x372 + x2*x377 - x2*x384 - x291*(x288*x426 + x289 + x425) - x294*x428 + x296*x429 + x298*x430 - x301*x426 + x315*x435 - x334*x443 - x337*x444 - x345*x421 - x348*x426 - x352*x446 - x353*x447 - x364*x453 - x366*x436 - x368*x447 + x369*x454 + x373*x454 + x376*x455 - x378*x457 - x382*x456 + x390 + x442*x63; // xxxxzz
    result[6] = -x582*(-x313*x477 - x313*x494 - x326*x462 + x362*x557 - x413*(-x151*x466 - 153.0*x350 + 507.0*x379 - 33.0*x478 + 19.0*x479 + 48.0*x480 + 192.0*x482 - 192.0*x483 + x486 + x492 + x493) + x461 - x473*x474 + x476 + x497 + x501 + x504 + x507 + 27.0*x509 + 45.0*x511 - x513 - x517 - x520 - x521 - x523 - x525 + x527*x61 + x545*x546 + x550 + x553 + x556 + x560*x61 + x562 + x564 + 270.0*x566 + x568 + x570 + x573 + x574 + x581); // xxxyyy
    result[7] = x622*(-x1*x614 + x157*(-x151*x308 - 459.0*x350 + 1521.0*x379 - 99.0*x478 + 57.0*x479 + 144.0*x480 + 576.0*x482 - 576.0*x483 - x583 + x584 + x585 - x586 + x588) + x233*x313 + x235*x313 + x295*x404 + x297*x601 - x362*x609 - x461 - x497 - x501 - x504 - x507 - 9.0*x509 - 15.0*x511 + x513 + x517 + x520 + x521 + x523 + x525 - x528*x615 - x550 - x553 - x556 - x562 - x564 - 300.0*x566 - x568 - x570 - x573 - x574 + x597 + x599 + x600 + x602*x603 + x602*x604 - x605*x606 - x608 - x612*x63 - x617*x63 + x621); // xxxyyz
    result[8] = x582*(x157*(-x24*x626 - x432*x45 - 459.0*x445 + 1521.0*x456 + x588 - x623 - 99.0*x624 + x625 + x626 + 57.0*x627 + 144.0*x628 + 576.0*x629 - 576.0*x630) - x177*x606*x659 - x2*x614 + x233*x435 + x235*x435 + x404*x429 + x430*x601 - x453*x609 + x603*x654 + x604*x654 - x615*x639 + x621 - x63*x672 - x63*x686 - x631 - x634 + x644 + x645 + x646 - x648 - 15.0*x650 - 9.0*x652 - x653 - x655 - x656 - x658 - x660 - x662 - x673 - x675 + x676 + x678 + x679 + x681 + x682 + x683 - x684 - 300.0*x685 - x689 - x690 - x693); // xxxyzz
    result[9] = -x622*(-x413*(-x151*x694 + 507.0*x456 + x587 + 19.0*x627 + 192.0*x629 - 192.0*x630 + x700 + x704 + x705) - x435*x477 - x435*x494 - x440*x462 + x453*x557 - x474*x697 + x546*x708 + x581 + x61*x707 + x61*x709 + x631 + x634 + x648 + 45.0*x650 + 27.0*x652 + x653 + x655 + x656 + x658 + x660 + x673 + x675 - x676 - x678 - x679 - x681 - x682 - x683 + x684 + 270.0*x685 + x689 + x690 + x693 + x698); // xxxzzz
    result[10] = a*x205*x761 - x1*x214*x508 + x1*x326*x769 + x175*x282 - x282*x796 - x287*x373*x545 + x287*x714 - x314*x751 - x327*x712 - x328 - x374*x375 + x374*x505 + 990.0*x380 + x383*x795 + x389*x510 + x413*(-x1*x407 + x1*x411 - x1*x723 - x1*x724 + x1*x730 + x24*x718 - x24*x719 - x24*x722 + x397 + x536 - x718 + x719 - 35.0*x720 + x722 + x725*x726 + x727*x728 - x727*x729) + x46*x72*x761 + x508*x67 - x511*x795 - x516*x753 + x583*x713 + x604*x768 - x63*x787 - x63*x799 - x710*x711 - x710*x716 - x710*x757 - x710*x779 - x710*x789 - x710*x791 - x710*x792 - x717*x776 + x725*x774 - x725*x777 - x727*x794 - 6.0*x755 + x758*x760 + x762*x763 + x764*x765 + x765*x767 + x770*x771 + x770*x772 + 45.0*x775 - x797*x798 + 90.0*x800 + x801; // xxyyyy
    result[11] = -x414*(x1*x789 + x1*x838 + x282*x840 + x292*x776 + x314*x827 - x326*x807 - x336*x836 - x413*(-35.0*x350 + 443.0*x379 + 93.0*x482 - 128.0*x483 + x486 - x804 + x805 + x806) - x473*x477 - x473*x494 - x475*x602 + x476 - x494*x596 + 54.0*x509 + 90.0*x511 - x516*x771 - x516*x830 - x516*x831 - x518*x602 + x526*x832 + x527*x63 + x545*x833 + x560*x63 + 510.0*x566 - x597 - x600 + x608 + x611*x835 + x63*x828 + x63*x841 + x63*x844 + x756*x834 + x803 + x808 - x829 + x837 + x842 + x846); // xxyyyz
    result[12] = x1*x333*x440 + x1*x39*x500 + x1*x645 - 21.0*x1*x652 + x155*x336*x440 + x157*(1329.0*x2*x379 + x2*x585 - x2*x586 - x308 + x309 - 384.0*x379*x872 + x397 - x431 + x432 + 279.0*x481*x849 + x542 - x590 - x592 + x594 + x635 - x636 - x637 + x638 - 105.0*x871 + x879) - 15.0*x18 + 6.0*x192*x861 + x2*x326*x333 - x2*x342*x63*x719 - 21.0*x2*x509 + x2*x599 - x2*x803 - x2*x808 + x2*x829 - x2*x837 - x2*x842 - x233*x326 - x233*x440 - x235*x326 - x235*x440 + x25*x484 + x25*x699 + x270*x854 - 7.5*x270*x858 - x287*x363*x671 - x291 + x293*x848 + 2.0*x295*x502*x654 - x30*x547 - x314*x890 - x321*x375 + x321*x505 - x321*x63*x651 + x326*x864 + x333*x768 + x333*x857 - x363*x426*x611 + x363*x861 - x371*x762 - x371*x859 - x375*x436 + 165.0*x380 + x383*x851 + x383*x852 - x385*x63 - x39*x406 - x39*x598 + x39*x674 - 7.5*x416*x796 + x416*x854 + x428*x848 + x436*x505 - x436*x508*x63 + 165.0*x457 + x508*x52 + x510*x853 - x511*x852 + x52*x651 - 540.0*x565*x849 + x596*x863 + x596*x865 - 60.0*x613*x849 + x643*x764 + x643*x767 + x649*x853 - x650*x851 - x755 - x757*x849 + x771*x862 + 7.5*x775 - x776*x856 - x789*x849 - x794*x850 + 15.0*x800 + x830*x862 + x831*x862 - x838*x849 + 15.0*x847 + 7.5*x855 - x860 - x869*x870; // xxyyzz
    result[13] = -x414*(x2*x757 + x2*x789 + x2*x838 + x314*x902 - x375*x904 - x413*(x24*x891 - 35.0*x445 + 443.0*x456 + 93.0*x629 - 128.0*x630 + x700 + x806 - x891) + x416*x778 + x421*x840 + x426*x790 + x426*x802 + x427*x776 - x440*x807 - x444*x836 - x475*x654 - x477*x697 - x494*x643 - x494*x697 - x518*x654 + x63*x633 + x63*x707 + x63*x709 + x63*x903 + x63*x905 + x63*x906 - x644 - x646 + 90.0*x650 + 54.0*x652 + x662 + x671*x835 - x680*x771 - x680*x830 - x680*x831 + 510.0*x685 + x698 + x706*x832 + x708*x833 + x846); // xxyzzz
    result[14] = x175*x421 - x214*x931 - x314*x922 - x375*x455 + x383*x930 + x389*x649 + x413*(-x2*x407 + x2*x411 - x2*x723 - x2*x724 + x2*x730 - x24*x908 + x397 + x726*x909 + x728*x910 - x729*x910 + x908 + x914) - x421*x858 + x426*x714 - x426*x933 - x441*x712 - x442 + x455*x505 + 990.0*x457 + x604*x857 + x604*x924 + x623*x713 - x63*x934 - x650*x930 + x651*x67 - x680*x753 - x711*x907 - x716*x907 - x757*x907 + x760*x923 + x763*x859 + x769*x924 + x771*x927 + x772*x927 + x774*x909 - x776*x911 - x777*x909 - x779*x907 - x789*x907 - x791*x907 - x792*x907 - x794*x910 - x798*x932 + x801 + 90.0*x847 + 45.0*x855 - 6.0*x860 + x863*x926 + x865*x926 - x870*x929 + x924*x925; // xxzzzz
    result[15] = -x582*(-x115*x508 + x157*(-x24*x939 + 2100.0*x350 + 1350.0*x478 - 1050.0*x480 + 50.0*x812 - x815*x938 + 400.0*x815 + x935 - x936 - 450.0*x937 + x940 + x948) + x186*x951 - x210*x545 - x253*x510 + 75.0*x270*x508 - 4725.0*x495 + 75.0*x526*x552 - 2100.0*x571 - x949 + 2.5*x950 + 525.0*x952 + 262.5*x953 + x959 + x960 + x964); // xyyyyy
    result[16] = -x622*(x1*x972 - x107*x510 - x128*x611 + x157*(-x104*x815 - x24*x968 + 1260.0*x350 + 810.0*x478 + 30.0*x812 - 6.0*x814 + 240.0*x815 - 270.0*x937 + x948 + x966 - x967 + x969) + x373*x951 - x374*x839 - 2835.0*x495 - x508*x66 + x508*x738 + x510*x583 - 1260.0*x571 + x710*x974 + x827*x971 + x950 + 472.5*x953 + x964 + x965 + x970 + x975); // xyyyyz
    result[17] = -x582*(x157*(-x223*x898 - x24*x893 - x437*x94 + x488 - x489 + x623 + 405.0*x624 - x625 - 315.0*x628 + x809 + x810 + x811 + x813 - x814 - x816 - x817 - x818 + 15.0*x895 + 120.0*x898 + x976 + x980) + x2*x972 + x233*(x2*x819 + x2*x820 - x2*x821 - x24*x664 + x423 - 3.0*x667 + x742 + x877 + x888 + x916) - x416*x981 - x453*x604 - x496 + x508*x691 + x518*x982 - x527 + x545*x983 - x607 - 1417.5*x632 + x651*x719 - x672 - x686 - 630.0*x687 + x827*x863 - x828 - x841 - x844 + 52.5*x984 + x986 + x988); // xyyyzz
    result[18] = -x622*(x1*x518*x708 + x157*(-x223*x815 - x24*x810 - x322*x94 + 405.0*x478 - 315.0*x480 + x583 - x584 + x701 - x702 + 15.0*x812 + 120.0*x815 + x892 + x893 + x894 + x896 - x897 - x899 - x900 - x901 + x968 + x980) + x233*(x1*x819 + x1*x820 - x1*x821 + x284 - 3.0*x540 + x734 + x742 + x874 + x875 + x878 + x880 + x881 + x882 + x883 + x884 + x885 + x886 + x887 + x889 + x990) - x270*x981 - x362*x604 - 1417.5*x495 + x508*x904 - 630.0*x571 + x604*x982 + x611*x983 - x612 - x617 - x633 - x661 - x707 + x764*x902 - x903 - x905 - x906 + 157.5*x984 + 52.5*x985 + x988 + 7.5*x991 + 67.5*x992); // xyyzzz
    result[19] = -x582*(x1000*x671 + x1001*x373 + 472.5*x1002 + x1003 - x107*x649 - x128*x671 + x157*(-x104*x898 - x24*x976 - x24*x994 + 1260.0*x445 + 810.0*x624 + 30.0*x895 - 6.0*x897 + 240.0*x898 + x969 + x994 - 270.0*x995 + x999) + x187*x706*x904 + x333*x929 - x455*x839 + x623*x649 - 2835.0*x632 - x651*x66 + x651*x915 - 1260.0*x687 + 2.0*x863*x902 + x907*x974 + x975 + x993); // xyzzzz
    result[20] = -x1007*x622; // xzzzzz
    result[21] = -x1*x128*x958 - x1008*x1009 - x1011*x1012*x42 - x1014*x42*x797 - x1015*x786*x87 - x157*(x1*x150*x24 + x1010*x1025 - x1010*x135 - x1010*x137 - x1010*x141 + x1010*x147 - x1010*x942 + x1016*x24 - x1016 + x1017*x24 - x1017 - x1018*x24 + x1018 - 1350.0*x1019 - x102*x747 - 810.0*x1020 + x1021*x24 - 6.0*x1021 - x1022*x145 + 2025.0*x1022 - 1575.0*x1023 + x1024*x149 + x1024*x153 + 675.0*x1026 + x154 - 180.0*x538 + 45.0*x540 + 3150.0*x720 + 75.0*x745 - 15.0*x746 + 600.0*x747) - x27*(x1010*x22 + 105.0*x297 - 315.0*x758 - 5.0); // yyyyyy
    result[22] = -x414*(x1008*x167 + x1008*x169 + 37.5*x1011*x165 + x1011*x170*x172 - x1013*x1040*x186 + 15.0*x1013*x1046 + 75.0*x1013*x605 - x1015*x1045*x210 + x1015*x193*x526 + x1015*x949 - 2.5*x1037*x86 + 150.0*x1048*x571 - x157*(-x104*x945 + 35.0*x140*x710 - 315.0*x151*x717 - x238*x270 + x238*x717 - x24*x249*x710 + x24*x811 + x251*x478 + x257 - 1950.0*x350 + 900.0*x480 + 1785.0*x727 - 220.0*x815 - x935 + x936 - x939 + x941 + x943 - x944 + 285.0*x945 - 840.0*x947) + 2.5*x192*x786 + x235*x958 + 210.0*x495*(9.0*x297 - 5.0) + 150.0*x952 + x959 + x965); // yyyyyz
    result[23] = -x1*x1013*x363*x453 - x1011*x333*x443 + x1011*x385 - 52.5*x1011*x428 - 15.0*x1011*x446 - 60.0*x1013*x2*x569 - x1013*x793*x850 + x1014*x351 - x1015*x1053 - 21.0*x1015*x1054 + x1015*x1056 + x1015*x1057*x192*x2 + x1015*x1061 + x1037*x863 + x1037*x865 + 36.0*x1040*x2*x552 - 300.0*x1048*x1049 - x1048*x381*x850 - x1050*x510 - 36.0*x1051*x331*x849 - x1052*x1055 + x1052*x603 + x1052*x604 - x1058*x353 - x1058*x368 + x1059*x369 + x1059*x373 + x1066*x971 + x157*(x1027 + x1028 + x1029 - x1030 - x1031 - x1032 + x1033 + x1034 + x1035 - x1036 - 432.0*x1067 - 210.0*x1068*x24 + 825.0*x1068 + 432.0*x1069 + x2*x45*x739 + 1665.0*x2*x727 - 42.0*x2*x815 + x2*x941 - x2*x944 + 162.0*x2*x945 - 720.0*x2*x947 - x2*x966 + x2*x967 + x208 + 9.0*x417*x710 + x424 + x741 - x745 - 1062.0*x871 - 24.0*x872*x945 + x990) - x2*x339*x710 - x2*x598*x786 - x2*x965 - x2*x970 + x235*x786 - 30.0*x293*(-x1047 + x288*x849 + x425 + 3.0) - x343*x427*x710 + x381*x727 + x387*x797 + x506*x510 - x786*x864 + x787 + x799; // yyyyzz
    result[24] = -x414*(-x1013*x575 - x1013*x580 + x1013*x633 + x1013*x688 + x1013*x707 + x1013*x709 - 67.5*x1015*x165 + x1015*x477*x708 + x1015*x688 + x1015*x692 + x1040*x462 + x1040*x475 - 67.5*x1040*x657 - x1045*x2*x475 - x1045*x332*x444 + x1045*x477 + x1045*x494 - x1045*x983 + 85.5*x1051*x1080 + x1055*x526 - x1060*x462 - x1060*x475 - x1066*x477 - x1066*x494 - x1074*x474 + x1076*x647 - x1078*x514 - x1078*x522 - x1079*x172 + x1079*x453 + x1080*x332*x548 + x2*x526*x555 - x413*(-x1062 - x1063 - x1064 + x1065 - x1072*x45 - x1075*x24 + x1075 + 19.0*x138*x849 - 192.0*x24*x850 + x45*x529 + 192.0*x45*x856 + x492 + x703 + x705 + 507.0*x850) + x460*x849 - x475*x526 - 630.0*x495 - x514*x558 - x518*x526 - x522*x558 + x526*x674 - x526*x807 + x567*x849 - 27.0*x569 - 315.0*x571 - 67.5*x605 + 45.0*x984 + x986 + 270.0*x987 + 27.0*x992); // yyyzzz
    result[25] = -52.5*x10*x558*x909 + x1000*x1060 - x1009 - x1012*x23*x502*x907 - x1015*x233*x929 + x1015*x25*x623 - x1015*x27 - x1015*x421*x649 + x1015*x443*x604 + 90.0*x1015*x446 - x1015*x715*x907 - x1015*x793*x910 - x1015*x934 + x1040*x907*x973 + 1890.0*x1049 - x1050*x649 + x1053 + 45.0*x1054 - x1056 - x1057*x429*x502 - x1060*x15*x712 - x1061 + x1076*x455 + x1077*x759*x923 + x1077*x771*x907 + x1077*x773*x909 - x1078*x753 - x1081*x790 - x1081*x802 + x1082*x769 + x1082*x925 + x1083*x863 + x1083*x865 + 990.0*x17*x850 - 12.0*x2*x991 - 420.0*x292*x342*x907 - 90.0*x293 - x331*x475 - x331*x518 - x331*x788*x907 - x331*x807 + x374*x651 + x413*(-66.0*x1067 + 96.0*x1069 + x1070 + x1071 - x1073 + x1084*x24 - x1084 - x1085*x24 + x1085 - 128.0*x1086*x24 + 443.0*x1086 + 93.0*x292*x909 + x396 - 306.0*x871 + x876 + x914) + x499*x558*x859 + x506*x649 - 52.5*x510*x911 - 5.0*x548*x558*x907 + x569*x930 - x738*x931 - x764*x922 - x849*x933; // yyzzzz
    result[26] = -x1007*x414; // yzzzzz
    result[27] = -x1005*x128*x2 - x157*(-x102*x920 + x1025*x1087 - x1087*x135 - x1087*x137 - x1087*x141 + x1087*x147 - x1087*x942 + x1088*x24 - x1088 + x1089*x24 - x1089 - x1090*x24 + x1090 + x1091*x24 - 6.0*x1091 - x1092*x145 + 2025.0*x1092 + x1093*x149 + x1093*x153 + x150*x872 + x154 + 675.0*x2*x256 - 1350.0*x2*x68 - 810.0*x2*x78 - 1575.0*x24*x913 - 180.0*x665 + 45.0*x667 + 3150.0*x913 + 75.0*x918 - 15.0*x919 + 600.0*x920) - x27*(x1087*x22 + 105.0*x430 - 315.0*x923 - 5.0) - 22.5*x42*x443*(-30.0*x430 + 35.0*x923 + 3.0) - x42*x706*x852*(5.0*x430 - 3.0) - 45.0*x446*(-70.0*x430 + 63.0*x923 + 15.0) - x87*x929*(3.0*x430 - 1.0); // zzzzzz
    return result;
}
} // namespace tensors
} // namespace libcppe
